...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("BookingsListListReport journey");

        opaTest("Start application", function (Given, When, Then) {
            Given.iStartMyApp();

            Then.onTheBookingsListGenerated.iSeeThisPage();
        });
        ...
        //     When.onTheBookingsListGenerated.onFilterBar().iChangeSearchField("Search Term");
        //     When.onTheBookingsListGenerated.onFilterBar().iExecuteSearch();
        //     Then.onTheBookingsListGenerated.onTable().iCheckRows();
        // });
        ...
        opaTest("Navigate to ObjectPage", function (Given, When, Then) {
            ...
            When.onTheBookingsListGenerated.onTable().iPressRow(0);
            Then.onTheBookingsObjectPageGenerated.iSeeThisPage();
